...
import { FaHardHat, FaQuestionCircle, FaHandsHelping } from "react-icons/fa";
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <div className="community-note bg-gray-800 border border-gray-700 rounded-lg p-6 mx-auto">
        ...
        <div className="flex items-start">
          ...
          <p className="text-gray-300">
            Some of the data and components, like topics, participant numbers and messages, are not
            correct and are for demonstration purposes only.
          </p>
        </div>
